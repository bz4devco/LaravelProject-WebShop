  ...
  <script src="{{ asset('customer-assets/js/bootstrap/popper.min.js') }}"></script>
  ...
  <script src="{{ asset('customer-assets/js/forms/need-to-login.js') }}"></script>
  <script src="{{ asset('customer-assets/js/ajax/search-ajax.js') }}"></script>
