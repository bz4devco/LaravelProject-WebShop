                            ...
                            <td>
                                <section>
                                    <div class="custom-switch custom-switch-label-onoff d-flex align-market-center" dir="ltr">
                                        <input data-url="{{ route('admin.market.comment.status', $comment->id) }}" onchange="changeStatus(this.id)" class="custom-switch-input" id="{{ $comment->id }}" name="status" type="checkbox" @checked($comment->status) >
