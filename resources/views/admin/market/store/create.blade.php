...
@section('haed-tag')
<title> ایجاد انبار جدید | پنل مدیریت</title>
@endsection
...
<ol class="breadcrumb m-0 font-size-12">
    ...
    <li class="breadcrumb-item active" aria-current="page">ایجاد انبار جدید</li>
</ol>
</nav>
<!-- category page Breadcrumb area -->
                    ...
                    <section class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select form-select-sm" name="" id="">
                                    ...
                                    <option value="56877">سامسونک LED</option>
                                    <option value="78971">لپ تاپ سامصونگ</option>
                                    <option value="56785">موبایل سامسونک	</option>
                                </select>
                            </div>
                        </section>
                        <section class="col-12 col-md-6">
