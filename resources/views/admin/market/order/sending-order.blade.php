...
@section('haed-tag')
<title>سفارشات در حال ارسال | پنل مدیریت</title>
@endsection
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb m-0 font-size-12">
        ...
        <li class="breadcrumb-item active" aria-current="page">سفارشات در حال ارسال</li>
    </ol>
</nav>
<!-- category page Breadcrumb area -->
            ...
            <section class="table-responsive overflow-x-auto">
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr class="align-middle">
                            <th colspan="" class="text-center emptyTable  py-4">جدول سفارشات درحال ارسال خالی می باشد</th>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
