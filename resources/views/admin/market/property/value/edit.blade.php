...
@section('haed-tag')
<title>ویرایش مقدار فرم کالا | پنل مدیریت</title>
@endsection
...
<section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="">
                <form id="form" action="{{ route('admin.market.property.value.update', ['categoryAttribute' => $categoryAttribute->id, 'value' => $value->id] ) }}" method="post">
                    @csrf
                    @method('PUT')
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control form-select-sm" type="text" name="value" id="value" value="{{old('value', json_decode($value->value)->value)}}">
                                @error('value')
                                    <span class="text-danger font-size-12">
                                        <strong>
                                            {{ $message }}
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm">
                                    <input type="text" class="form-control form-price form-control-sm  number money" name="price_increase" id="price_increase" value="{{old('price_increase', number_format(json_decode($value->value)->price_increase))}}" placeholder="100,000" aria-label="100,000" aria-describedby="price_increase">                                
