...
<title> افزودن کالا به فروش شگفت انگیز | پنل مدیریت</title>
@endsection
...
<section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="">
                <form id="form" class="num-input-check" action="{{ route('admin.market.discount.amazing-sale.store') }}" method="post">
                    @csrf
                    <section class="row">
                        <section class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select form-select-sm" name="product_id" id="product_id">
                                    ...
                                    <option value="{{$productName->id}}" @if (old('product_id') == $productName->id) selected @endif>{{$productName->name}}</option>
                                    @empty
