                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group  input-group-sm number-spinner">
                                    ...
                                    <input class="input-step-number form-control number text-center rounded-0" name="percentage" id="percentage" value="{{ old('percentage', $commonDiscount->percentage) ?? 0 }}%" data-char="%" type="text" step="5" min="0" max="100">
                                    <span class="input-group-btn ">
