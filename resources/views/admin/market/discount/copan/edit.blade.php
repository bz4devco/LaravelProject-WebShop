...
<script>
    ...
    <div class="input-group  input-group-sm number-spinner">
        ...
        <input class="input-step-number form-control number text-center rounded-0" name="amount" id="amount" value="{{ (old('amount_type' , $copan->amount_type) == 0) ? (old('amount', $copan->amount) ?? 0) : 0 }}%" data-char="%" type="text" step="5" min="0" max="100">
        <span class="input-group-btn ">
