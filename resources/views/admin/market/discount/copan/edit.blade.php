                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select form-select-sm" name="type" id="type">
                                    <option value="0" @selected(old('type', $copan->type)==0) >عمومی</option>
                                    <option value="1" @selected(old('type', $copan->type)==1) >خصوصی</option>
                                </select>
                                @error('type')
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group mb-1">
                                ...
                                <select class="form-select form-select-sm" name="user_id" id="user_id">
                                    ...
                                    <option value="{{$costumer->id}}" @selected(old('user_id', $copan->user_id) == $costumer->id) >{{$costumer->full_name}}</option>
                                    @empty
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select form-select-sm" name="amount_type" id="amount_type">
                                    <option value="0" @selected(old('amount_type', $copan->amount_type)==0) >درصدی</option>
                                    <option value="1" @selected(old('amount_type', $copan->amount_type)==1) >عددی</option>
                                </select>
                                @error('amount_type')
                                <span class="text-danger font-size-12">
                                    <strong>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select form-select-sm" name="status" id="status">
                                    <option value="0" @selected(old('status', $copan->status)==0) >غیر فعال</option>
                                    <option value="1" @selected(old('status', $copan->status)==1) >فعال</option>
                                </select>
                                @error('status')
                                <span class="text-danger font-size-12">
                                    <strong>
