...
@section('haed-tag')
<title> ایجاد گارانتی | پنل مدیریت</title>
@endsection
...
<ol class="breadcrumb m-0 font-size-12">
    ...
    <li class="breadcrumb-item deco"><a class="text-decoration-none" href="{{ route('admin.market.product.guarantee.index', $product->id) }}">گارانتی</a></li>
    ...
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="d-flex justify-content-between align-items-center mt-4 pb-3 mb-3 border-bottom">
                <a href="{{ route('admin.market.product.guarantee.index', $product->id) }}" class="btn btn-sm btn-info text-white">بازگشت</a>
            </section>
            <section class="">
                <form id="form" action="{{ route('admin.market.product.guarantee.store', $product->id) }}" method="post">
                    @csrf
                    <section class="row">
