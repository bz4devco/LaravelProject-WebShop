                            ...
                            <div class="form-group mb-3">
                                ...
                                <section class="row">
                                    <section class="col-md-6 mt-2">
                                        <img src="{{asset($admin->profile_photo_path)}}" class="rounded-3" width="100" alt="avatar">
                                    </section>
                                </section>
                                @endif
                            </div>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select form-select-sm" name="status" id="status">
                                    <option value="0" @selected(old('status', $admin->status) == 0) >غیر فعال</option>
                                    <option value="1" @selected(old('status', $admin->status) == 1) >فعال</option>
                                </select>
                                @error('status')
                                    <span class="text-danger font-size-12">
                                        <strong>
