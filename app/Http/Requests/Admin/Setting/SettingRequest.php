...
class SettingRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'base_url' => 'nullable|max:120|min:2|url',
            'keywords' => 'nullable',
            ...
            'telegram' => 'nullable|max:120|min:2|url',
            'instagram' => 'nullable|max:120|min:2|url',
            'twitter' => 'nullable|max:120|min:2|url',
            'linkedin' => 'nullable|max:120|min:2|url',
            'google_plus' => 'nullable|max:120|min:2|url',
